          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
              ...
              <div className="flex space-x-4">
                <a href="https://instagram.com/lunagraphics" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-800 rounded-lg flex items-center justify-center hover:bg-primary-700 transition-colors cursor-pointer" aria-label="Instagram">
                ...
                <a href="https://pinterest.com/lunagraphics" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-800 rounded-lg flex items-center justify-center hover:bg-primary-700 transition-colors cursor-pointer" aria-label="Pinterest">
            ...
            <div>
              ...
              <ul className="space-y-3 text-primary-200" itemScope itemType="https://schema.org/OfferCatalog">
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/Offer">
                  <a href="/corporate-services/election-campaigns" className="hover:text-white transition-colors" itemProp="name">Election Campaigns</a>
                </li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/Offer">
                  <a href="/corporate-services/corporate-branding" className="hover:text-white transition-colors" itemProp="name">Corporate Branding</a>
                </li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/Offer">
                  <a href="/corporate-services/large-format-printing" className="hover:text-white transition-colors" itemProp="name">Large Format Printing</a>
                </li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/Offer">
                  <a href="/corporate-services/event-materials" className="hover:text-white transition-colors" itemProp="name">Event Materials</a>
                </li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/Offer">
                  <a href="/corporate-services/custom-merchandise" className="hover:text-white transition-colors" itemProp="name">Custom Merchandise</a>
                </li>
              </ul>
            </div>
