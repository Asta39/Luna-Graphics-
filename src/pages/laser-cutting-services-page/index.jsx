  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="keywords" content="laser cutting Nairobi, laser engraving Kenya, acrylic laser cutting, wood laser engraving, precision laser cutting Nairobi, custom laser cutting, laser cut signage, leather engraving, MDF laser cutting, Luna Graphics laser services" />
